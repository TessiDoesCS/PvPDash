...
public class TeamUpdateRequest : DataType<TeamUpdateRequest>
{
    /* we send playerID and team as well, but it shouldnt be necessary */
    public DataPlayerInfo player;
    public uint playerID;
    public int team;
    public string cNetChannel;

    static TeamUpdateRequest()
    {
        DataID = "PvPDashTeamUpdateRequest";
    }
